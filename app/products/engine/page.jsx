...
export default function EngineAndTransmissionSections() {
  ...
  const images = tab === "engine"
    ? [engineData.heroImage, engineData.heroImage1, engineData.heroImage2, engineData.heroImage3]
    : [engineData.transmission.heroImage, engineData.transmission.heroImage1, engineData.transmission.heroImage2, engineData.transmission.heroImage3];
