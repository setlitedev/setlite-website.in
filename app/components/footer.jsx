  ...
  return (
    <footer className="bg-black text-white"> 
      ...
      <div className="container mx-auto px-4 py-12 flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="mb-10 md:mb-0 mt-20 max-w-md">
          {/* Logo */}
        ...
        <div className="flex flex-col md:flex-row md:space-x-16 mt-20">
          {/* Quick Links */}
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold mb-3">Head Office</h4>
            <ul className="text-sm text-gray-400 space-y-3 max-w-xs">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+911123311111" className="hover:text-yellow-500">
                  +91-11-23311111
                </a>
              </li>
              <li className="flex items-center">
