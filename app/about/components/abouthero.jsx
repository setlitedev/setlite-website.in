  ...
  return (
    ...
    >
      ...
      <div className="relative w-[85vw] md:w-[75vw] lg:w-[70vw] mx-auto flex flex-col text-left z-10 px-4 sm:px-6 lg:px-8">
        {/* Heading */}
        <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold mb-8 leading-tight uppercase">
        ...
        <div className="max-w-3xl">
          <p className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-xl text-gray-300 mb-8 leading-relaxed">
